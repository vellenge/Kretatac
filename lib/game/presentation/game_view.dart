                            ...
                            child: Container(
                              ...
                              child: Wrap(children: [
                                ...playedValue.map(
                                  (e) => Container(
                                    margin:
                                        const EdgeInsets.only(right: Sizes.p8),
                                    width: 40,
                                    child: RectoIdeaWidget(
                                      ...
                                      onPressed: () {
                                        ref
                                            ...
                                            .retrieveIdeaFromTableToHand(e);
                                      },
                                    )
                                        .animate(
                                            controller: useAnimationController(
                                                lowerBound: 0.6))
                                        .scale(curve: Curves.elasticInOut),
                                  ),
                                ),
                              ]),
                            ),
